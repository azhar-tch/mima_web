...
export class EscortMissionsComponent implements OnInit {
  ...
  openAddDialog(): void {
    alert('La fonctionnalité d\'ajout de mission d'escorte sera bientôt disponible. Le dialog d\'ajout doit être créé.');
    console.log('TODO: Créer le dialog d\'ajout pour mission d'escorte');
  }
}
