...
export class EditHrFunctionDialogComponent implements OnChanges {
  ...
  @Input() hr-functions: HRFunction | null = null;
  ...
  ngOnChanges(changes: SimpleChanges) {
    if (changes['hr-functions'] && this.hr-functions) {
      this.formData = {
        functionName: this.hr-functions.functionName || '',
        description: this.hr-functions.description || '',
        hierarchyLevel: this.hr-functions.hierarchyLevel
      };
    }
  }
