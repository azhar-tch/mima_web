...
export class AgentGradeHistoryComponent implements OnInit {
  ...
  openAddDialog(): void {
    alert('La fonctionnalité d\'ajout de historique de grade sera bientôt disponible. Le dialog d\'ajout doit être créé.');
    console.log('TODO: Créer le dialog d\'ajout pour historique de grade');
  }
}
